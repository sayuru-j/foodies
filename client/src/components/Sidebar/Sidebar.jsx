...
function Sidebar() {
  ...
  return (
    <div className="fixed left-0 z-50 md:flex hidden bg-white flex-col px-2 py-2 justify-between h-screen lg:w-64 md:w-16 border-r-[1px] border-slate-950/5 transition-all duration-500 ease-out ">
      ...
      <div id="bottom" className="max-h-16 relative h-full flex items-center ">
        <div
        ...
        >
          ...
          <div className="flex gap-2 cursor-pointer lg:justify-normal justify-center items-center w-full hover:bg-accent/30 p-2 px-4 rounded-b-md">
